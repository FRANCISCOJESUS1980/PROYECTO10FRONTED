  ...
  app.innerHTML = `
    <div class="home-container">
      ...
      <main class="home-main">
        <section class="explicacion-pagina">
          <h2>Como Crear Eventos</h2>
          <p>Para crear eventos, tienes que registrarte o loguearte y una vez hecho pulsar el botón de crear eventos y rellenar los campos obligatorios...</p>
        </section>
        <section class="about-section">
          <h2>Sobre Nosotros</h2>
          <p>Somos líderes en la organización de eventos únicos y memorables...</p>
        </section>
          ...
          <div class="event-grid">
            <div class="event-card">
              ...
              <div class="event-details">
                ...
                <p>Fecha: 15 de Julio, 2025</p>
                <p>Lugar: Estadio Central</p>
                <a href="/eventos" class="event-link">Más información</a>
              </div>
            </div>
            <div class="event-card">
              <img src="${event2Image}" alt="Festival de Gastronomía" class="event-image">
